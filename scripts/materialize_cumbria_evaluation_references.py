...
def validate_manifest(manifest: dict[str, Any]) -> None:
    if manifest.get("manifestVersion") not in {"0.26.0", "0.27.0", "0.28.0"}:
        raise ValueError("Cumbria reference acquisition requires manifest v0.26.0, v0.27.0 or v0.28.0")
    ...
    if manifest.get("manifestVersion") in {"0.27.0", "0.28.0"}:
