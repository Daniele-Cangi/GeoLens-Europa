...
State: the public Sheepmount–Old Sandsfield Storm Desmond run completed all nine frozen scenarios from bounded real evidence; prediction receipt SHA-256 `f2a3a7489699a70a6d5c770633bdc9f789184ca26cb8190c85a1d28d40495dc6` was merged before reference access, the exact Environment Agency and Copernicus sources and their independent frozen-grid masks are content-addressed, and the next gate is the predeclared blind evaluation without retuning

Progress:

- manifest v0.28.0 retains the v0.25.0 execution source identity, the v0.26.0 prediction freeze, the raw evaluation-reference receipt and the later normalization receipt without rewriting any historical boundary; the primary 20 m wet mask remains maximum depth `>= 0.05 m` over the same 73,502-cell evaluation-domain mask and half-open 72-hour Storm Desmond window;
