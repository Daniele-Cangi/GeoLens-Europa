...
State: the public Sheepmount–Old Sandsfield Storm Desmond run completed all nine frozen scenarios from bounded real evidence; every scenario has a verified checkpoint, 288 outputs and passing mass balance, prediction receipt SHA-256 `f2a3a7489699a70a6d5c770633bdc9f789184ca26cb8190c85a1d28d40495dc6` is frozen, and blind evaluation remains gated only by the still-sealed Environment Agency and Copernicus reference geometry

Progress:

- manifest v0.26.0 retains the v0.25.0 execution source identity and freezes the completed prediction, its source commit/tree, model and transformation versions, primary 20 m wet mask at maximum depth `>= 0.05 m`, 73,502-cell evaluation-domain mask and the unchanged half-open 72-hour Storm Desmond window from 4 December 2015 00:00 UTC to 7 December 2015 00:00 UTC;
...
- after this prediction-freeze checkpoint is merged, acquire and content-address the exact Environment Agency and Copernicus evaluation selections without changing prediction, domain, mesh, threshold or metric semantics;
