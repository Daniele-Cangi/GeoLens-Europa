...
- manifest v0.29.0 retains the v0.25.0 execution source identity, the v0.26.0 prediction freeze, the raw evaluation-reference receipt and the later normalization receipt without rewriting any historical boundary; it additionally binds the reviewed evaluator commit `5d34bc1` and Git-blob SHA-256 `f029baef594f8710fef9d79f1efadd8eae27586e6f371b9e57a39151128ae4f6` before any metric run, while the primary 20 m wet mask remains maximum depth `>= 0.05 m` over the same 73,502-cell evaluation-domain mask and half-open 72-hour Storm Desmond window;
