...
State: public Sheepmount–Old Sandsfield domain and real bounded terrain windows materialized with explicit gaps; remaining public inputs, replacement-solver definition and blind evaluation still gated

Progress:

- manifest v0.16.0 freezes a bounded Carlisle source-discovery envelope, a separate local hydraulic-protocol envelope, the public Sheepmount–Old Sandsfield baseline domain, its verified terrain materialization result and the half-open 72-hour Storm Desmond window from 4 December 2015 00:00 UTC to 7 December 2015 00:00 UTC;
